      ...
      <div class="login-container">
          <div class="login-info-container">
            ...
            <form class="inputs-container">
                ...
                <p><a class="botons" href="bolsillo?sc=dashboard" type="submit">Ingresar</a></p>
                <p>¿Aun no tienes cuenta? <span class="span" href="bolsillo?sc=registro">Registrate</span></p>
            </form>
          </div>
      </div>
